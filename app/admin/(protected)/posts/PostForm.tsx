...
import { savePost, type PostActionState } from "./actions";
    ...
    <form action={formAction} className="max-w-2xl space-y-6">
      ...
      <Field label="Tags (comma-separated)">
        <input
          ...
          placeholder="education, outreach, updates"
          className={inputClass}
        />
      </Field>
      ...
      <Field label="Excerpt">
        <textarea
          ...
          rows={2}
          maxLength={300}
          placeholder="Short summary shown on blog cards and list pages."
          className={inputClass}
        />
      </Field>
      ...
      <CoverImageUploader
        ...
        initialPublicId={post?.coverImagePublicId}
      />
